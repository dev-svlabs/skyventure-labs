...
export function DevStudiosWhoSection() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          ...
          <div className="flex flex-col pr-0 lg:pr-16">
            ...
            <ul className="flex flex-col gap-4">
              {[
                "Need technology built for long-term scale",
                "Operate in regulated or high-stakes environments",
                "Value reliability, security, and ownership",
                "Want partners, not short-term vendors",
              ].map((item, i) => (
