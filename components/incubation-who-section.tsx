...
export function IncubationWhoSection() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          ...
          <div className="flex flex-col pr-0 lg:pr-16">
            ...
            <ul className="flex flex-col gap-4">
              {[
                "Are preparing for serious capital or grants",
                "Have real products or infrastructure underway",
                "Understand that structure precedes capital",
                "Want durable outcomes, not short-term hype",
              ].map((item, i) => (
          ...
          <div className="mt-10 lg:mt-0">
            ...
            <div className="relative w-full aspect-[4/3] rounded-sm overflow-hidden">
              <Image
                src="/images/incubation/office.png"
